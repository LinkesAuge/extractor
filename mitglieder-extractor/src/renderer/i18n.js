...
(function () {
  const translations = {
    ...
    de: {
      ...
      'section.qualityChecks': 'Qualitaetspruefung',
      'label.scoreOutlierThreshold': 'Score-Ausreisser:',
      'label.scoreChangeThreshold': 'Score-Aenderung:',
      ...
      'ollama.error': 'Fehler',
      'ollama.testNoModel': 'Bitte zuerst ein Modell auswaehlen und herunterladen.',
      'ollama.testRunning': 'Test wird ausgefuehrt...',
      'ollama.testSuccess': 'Test bestanden! Modell funktioniert korrekt.',
      'ollama.testFailed': 'Test fehlgeschlagen',
      'ollama.openModelsFolder': 'Modell-Ordner oeffnen',
      ...
      'status.noModelSelected': 'Bitte zuerst ein Vision-Modell auswaehlen und herunterladen.',
      ...
      'placeholder.correctionFrom': 'OCR-Name (falsch)...',
      'placeholder.correctionTo': 'Korrekter Name...',
      'btn.addCorrection': 'Korrektur hinzufuegen',
      'btn.importCsv': 'CSV importieren',
      'btn.importNames': 'Namen importieren',
      'btn.exportNames': 'Namen exportieren',
      'btn.importCorrections': 'Korrekturen import.',
      'btn.exportCorrections': 'Korrekturen export.',
      'btn.revalidate': 'Erneut validieren',
      'label.ocrResults': 'OCR-Ergebnisse',
      'label.knownPlayers': 'Bekannte Spieler',
      'label.corrections': 'Korrekturen',
      'status.csvImported': '{count} Eintraege aus CSV importiert.',
      ...
      'th.score': 'Macht',
      'th.power': 'Macht',
      'th.eventPoints': 'Event-Punkte',
      'tooltip.clickToEdit': 'Klicken zum Bearbeiten',
      'tooltip.scoreWarning': 'Verdaechtig: Macht = Event-Punkte — wahrscheinlich ein OCR-Fehler. Klicken zum Bearbeiten.',
      'tooltip.historyCoords': 'Koordinaten geaendert — vorher',
      'tooltip.historyScore': 'Score geaendert — vorher',
      'tooltip.deleteEntry': 'Eintrag loeschen',
      'tooltip.revertValue': 'Vorherigen Wert wiederherstellen',
      'tooltip.insertIntoResults': 'In OCR-Ergebnisse einfuegen',
      'tooltip.lastSeen': 'Zuletzt gesehen',
      ...
      'validation.warnings': '{count} Warnung(en)',
      ...
      'format.nameCountDetailed': '{count} Namen ({found} gefunden, {missing} fehlen)',
      ...
      'btn.deleteSelected': 'Ausgewaehlte loeschen',
      'btn.deleteSelectedCount': '{count} loeschen',
      'confirm.deleteEntries': '{count} Eintrag/Eintraege wirklich loeschen? Dies kann nicht rueckgaengig gemacht werden.',
      'confirm.deleteEntry': 'Eintrag "{name}" wirklich loeschen?',
      ...
      'subtab.event': 'Event',
      'subtab.knownPlayers': 'Bekannte Spieler',
      'subtab.corrections': 'Korrekturen',

      // Tooltips
      'tooltip.makeCorrection': 'Korrektur erstellen',
      'tooltip.correctionActive': 'Diese Korrektur wird in den aktuellen Ergebnissen verwendet',
      'placeholder.searchCorrection': 'Korrektur suchen...',
      'prompt.makeCorrection': 'Korrekten Namen eingeben fuer "{name}":',

      // Event-spezifisch
      'section.eventRegion': 'Event-Region',
      'section.eventCalibration': 'Event-Kalibrierung',
      'section.eventCapture': 'Event-Capture',
      'section.eventOcrSettings': 'Event-OCR Einstellungen',
      'section.eventEvaluation': 'Event-Auswertung (OCR)',
      'section.eventGallery': 'Event-Galerie',
      'btn.selectEventRegion': 'Event-Region auswaehlen',
      'btn.startEventCapture': 'Event-Capture starten',
      'btn.testEventScroll': 'Test-Scroll',
      'btn.eventEvaluate': 'Auswerten',
      'btn.exportEventCsv': 'Event-CSV exportieren',
      'label.eventCaptureFolder': 'Event-Capture-Ordner:',
      'placeholder.eventOcrFolder': 'Ordner mit Event-Screenshots...',
      'th.power': 'Macht',
      'th.eventPoints': 'Event-Punkte',
      'status.eventMembersDetected': '{count} Spieler erkannt.',
      'result.eventPlayersFound': '{count} Spieler gefunden',
      'status.eventCsvSaved': 'Event-CSV gespeichert: {path}',
      'history.typeEvent': 'Event',
      'history.typeMember': 'Mitglieder',
      'th.type': 'Typ',
      'validation.modeEvent': 'Event-Modus',
      'validation.modeMember': 'Mitglieder-Modus',
      'format.eventPlayerCount': '{count} Spieler',
      ...
      'btn.copyLog': 'Kopieren',
      'btn.copied': 'Kopiert!',
      'btn.openLogFolder': 'Log-Ordner',

      // Dialog
      'dialog.selectOcrFolder': 'Capture-Ordner fuer OCR waehlen',
      'dialog.selectEngine': 'OCR-Engine waehlen',
      'dialog.addPlayer': 'Spieler hinzufuegen',
      'dialog.selectScreenshots': 'Screenshots auswaehlen',

      // Partial OCR / Re-run
      'btn.rerunOcr': 'OCR erneut',
      'btn.addScreenshots': '+ Screenshots',
      'tooltip.rerunOcr': 'OCR fuer ausgewaehlte Eintraege erneut ausfuehren',
      'tooltip.addScreenshots': 'Screenshots hinzufuegen und per OCR verarbeiten',
      'status.partialOcrRunning': 'Partial-OCR laeuft...',
      'status.partialOcrDone': '{count} Mitglieder aus Re-run hinzugefuegt.',
    ...
    en: {
      ...
      'section.qualityChecks': 'Quality Checks',
      'label.scoreOutlierThreshold': 'Score Outlier:',
      'label.scoreChangeThreshold': 'Score Change:',
      'toggle.autoOcr': 'Auto-OCR',
      'toggle.autoValidation': 'Auto-Valid.',
      'label.scale': 'Scaling:',
      ...
      'ollama.error': 'Error',
      'ollama.testNoModel': 'Please select and download a model first.',
      'ollama.testRunning': 'Running test...',
      'ollama.testSuccess': 'Test passed! Model is working correctly.',
      'ollama.testFailed': 'Test failed',
      'ollama.openModelsFolder': 'Open models folder',
      ...
      'status.noModelSelected': 'Please select and download a vision model first.',
      ...
      'placeholder.correctionFrom': 'OCR name (wrong)...',
      'placeholder.correctionTo': 'Correct name...',
      'btn.addCorrection': 'Add correction',
      'btn.importCsv': 'Import CSV',
      'btn.importNames': 'Import Names',
      'btn.exportNames': 'Export Names',
      'btn.importCorrections': 'Import Corrections',
      'btn.exportCorrections': 'Export Corrections',
      'btn.revalidate': 'Revalidate',
      'label.ocrResults': 'OCR Results',
      'label.knownPlayers': 'Known Players',
      'label.corrections': 'Corrections',
      'status.csvImported': '{count} entries imported from CSV.',
      ...
      'th.score': 'Power',
      'th.power': 'Power',
      'th.eventPoints': 'Event Points',
      'tooltip.clickToEdit': 'Click to edit',
      'tooltip.scoreWarning': 'Suspicious: Power = Event Points — likely an OCR error. Click to edit.',
      'tooltip.historyCoords': 'Coords changed — previous',
      'tooltip.historyScore': 'Score changed — previous',
      'tooltip.deleteEntry': 'Delete entry',
      'tooltip.revertValue': 'Restore previous value',
      'tooltip.insertIntoResults': 'Insert into OCR results',
      'tooltip.lastSeen': 'Last seen',
      ...
      'format.nameCountDetailed': '{count} names ({found} found, {missing} missing)',
      ...
      'btn.deleteSelectedCount': 'Delete {count}',
      'confirm.deleteEntries': 'Really delete {count} entry/entries? This cannot be undone.',
      'confirm.deleteEntry': 'Really delete entry "{name}"?',
      ...
      'subtab.event': 'Event',
      'subtab.knownPlayers': 'Known Players',
      'subtab.corrections': 'Corrections',

      // Tooltips
      'tooltip.makeCorrection': 'Make correction',
      'tooltip.correctionActive': 'This correction is used in the current results',
      'placeholder.searchCorrection': 'Search corrections...',
      'prompt.makeCorrection': 'Enter correct name for "{name}":',

      // Event-specific
      'section.eventRegion': 'Event Region',
      'section.eventCalibration': 'Event Calibration',
      'section.eventCapture': 'Event Capture',
      'section.eventOcrSettings': 'Event OCR Settings',
      'section.eventEvaluation': 'Event Evaluation (OCR)',
      'section.eventGallery': 'Event Gallery',
      'btn.selectEventRegion': 'Select Event Region',
      'btn.startEventCapture': 'Start Event Capture',
      'btn.testEventScroll': 'Test Scroll',
      'btn.eventEvaluate': 'Evaluate',
      'btn.exportEventCsv': 'Export Event CSV',
      'label.eventCaptureFolder': 'Event Capture Folder:',
      'placeholder.eventOcrFolder': 'Folder with event screenshots...',
      'th.power': 'Power',
      'th.eventPoints': 'Event Points',
      'status.eventMembersDetected': '{count} players detected.',
      'result.eventPlayersFound': '{count} players found',
      'status.eventCsvSaved': 'Event CSV saved: {path}',
      'history.typeEvent': 'Event',
      'history.typeMember': 'Members',
      'th.type': 'Type',
      'validation.modeEvent': 'Event Mode',
      'validation.modeMember': 'Members Mode',
      'format.eventPlayerCount': '{count} players',
      ...
      'dialog.selectEngine': 'Select OCR Engine',
      'dialog.addPlayer': 'Add Player',
      'dialog.selectScreenshots': 'Select Screenshots',

      // Partial OCR / Re-run
      'btn.rerunOcr': 'Re-run OCR',
      'btn.addScreenshots': '+ Screenshots',
      'tooltip.rerunOcr': 'Re-run OCR for selected entries',
      'tooltip.addScreenshots': 'Add screenshots and process via OCR',
      'status.partialOcrRunning': 'Partial OCR running...',
      'status.partialOcrDone': '{count} members added from re-run.',
